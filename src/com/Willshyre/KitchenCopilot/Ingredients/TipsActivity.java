...
public class TipsActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		  ...
		  final String[] Ingredients = getResources().getStringArray(R.array.TipName);
		  ...
		  lv.setOnItemClickListener(new OnItemClickListener() {
		    public void onItemClick(AdapterView<?> parent, View view,
		    	...
		    	if (position == 0) {
		    		...
		    		intent.setData(Uri.parse("market://details?id=com.Willshyre.KitchenCopilotGold"));
		    		startActivity(intent);
		    	} else {
		      // When clicked, set the text to the case
			    Intent intent = new Intent().setClass(getBaseContext(), TipsDisplayActivity.class);
